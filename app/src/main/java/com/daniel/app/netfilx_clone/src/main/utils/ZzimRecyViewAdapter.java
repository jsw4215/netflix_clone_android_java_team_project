...
public class ZzimRecyViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    Context mContext;
    private List<ZzimResult> mList;
    int Position;

    public ZzimRecyViewAdapter(List<ZzimResult> items, Context context) {
        mList = items;
        mContext = context;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        ((ZzimRecyViewAdapter.ViewHolder) holder).onBind(mList.get(position));
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void onBind(ZzimResult item) {
