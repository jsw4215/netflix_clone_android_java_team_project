...
public class SearchPopularResult {
    ...
    public SearchPopularResult() {
    }

    public SearchPopularResult(int id, String title, String thumbnailImgUrl, String nfOriginal, String videoUrl) {
        this.id = id;
        this.title = title;
