...
public class NetflixOriginRecyViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    Context mContext;
    private List<NetflixOriginalResult> mList;
    int Position;

    public NetflixOriginRecyViewAdapter(List<NetflixOriginalResult> items, Context context) {
        mList = items;
        mContext = context;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        ((NetflixOriginRecyViewAdapter.ViewHolder) holder).onBind(mList.get(position));
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void onBind(NetflixOriginalResult item) {
